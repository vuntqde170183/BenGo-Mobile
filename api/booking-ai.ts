...
3. **Gợi ý phương tiện (Quyết định):**
   - Bạn PHẢI tìm loại xe NHỎ NHẤT có thể chở được món hàng. Nếu một loại xe không khả thi (do quá nặng, quá to, hoặc hàng đặc thù), bạn PHẢI kiểm tra loại xe lớn hơn tiếp theo theo thứ tự: BIKE -> VAN -> TRUCK.
   - **Quy tắc chọn xe:**
     - **BIKE:** Khối lượng <= 20kg VÀ Kích thước < 50cm. (Tuyệt đối không chở hàng dễ vỡ, đồ điện tử giá trị cao, hoặc hàng cồng kềnh).
     - **VAN:** Khối lượng <= 500kg VÀ Kích thước <= 1.8m. (Phù hợp cho hàng trung bình, đồ điện tử, hàng cần che chắn).
     - **TRUCK:** Khối lượng > 500kg HOẶC Kích thước > 1.8m. (Giới hạn tối đa là 10 tấn và chiều dài 6m).
   - **Quan trọng:** Nếu hàng hóa dài 2m, nó vượt quá giới hạn của BIKE và VAN -> Bạn PHẢI gợi ý TRUCK thay vì kết luận không có xe.
4. **Kiểm soát tính hợp lệ và Giới hạn tối đa (Bổ sung):**
   - **Hàng cấm/Phạm pháp:** Tuyệt đối từ chối vận chuyển và trả về "NONE" cho các mặt hàng: ma túy, súng đạn, vũ khí, chất cháy nổ, xác người, hàng lậu...
   - **Hàng không thực tế:** Từ chối vận chuyển "NONE" cho các mặt hàng quá lớn (tàu ngầm, máy bay, hòn đảo...) hoặc quá nhỏ/vô lý (hạt cát, sợi chỉ, hạt bụi...).
   - **Vượt quá tải trọng:** TRUCK là phương tiện lớn nhất. Nếu hàng hóa vượt quá khả năng của TRUCK (ví dụ: >10 tấn hoặc kích thước siêu trường siêu trọng > 6m), hãy trả về "NONE".
   - **Hành động:** Khi trả về "NONE", phải giải thích rõ lý do trong 'vehicleReason' và 'conflictWarning'.
...
**JSON PHẢN HỒI (CHỈ TRẢ VỀ JSON, KHÔNG MARKDOWN, KHÔNG GIẢI THÍCH NGOÀI):**
{
  ...
  "analysis": {
    ...
    "compliance": "Đánh giá tuân thủ (vd: phù hợp luật GTĐB Việt Nam hoặc vi phạm hàng cấm)"
  },
  "recommendedVehicle": "BIKE|VAN|TRUCK|NONE",
  "vehicleReason": "Giải thích logic: Nêu rõ tại sao chọn loại xe này (ví dụ: 'Do hàng dài 2m vượt quá giới hạn xe máy và van, nên cần sử dụng xe tải để đảm bảo an toàn').",
  "suggestedNote": "Ghi chú hướng dẫn cho tài xế",
  "tips": ["Mẹo 1", "Mẹo 2"],
  "conflictWarning": "Cảnh báo nếu số liệu chênh lệch hoặc cảnh báo hàng cấm/quá tải"
}
...
Hãy thực hiện: 1. Gợi ý loại xe dựa TRÊN THÔNG TIN NGƯỜI DÙNG ĐÃ NHẬP. Nếu một loại xe không khả thi (ví dụ Xe máy quá tải), bạn PHẢI chuyển sang xem xét các loại xe lớn hơn (VAN, TRUCK) thay vì kết luận không vận chuyển được.
