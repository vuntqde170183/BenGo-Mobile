...
4. **Kiểm soát tính hợp lệ và Giới hạn tối đa (Bổ sung):**
   ...
   - **Vượt quá tải trọng:** TRUCK là phương tiện lớn nhất của chúng tôi. Nếu hàng hóa vượt quá khả năng của TRUCK (ví dụ: >10 tấn hoặc kích thước siêu trường siêu trọng), hãy trả về "NONE".
...
**JSON PHẢN HỒI (CHỈ TRẢ VỀ JSON, KHÔNG MARKDOWN, KHÔNG GIẢI THÍCH NGOÀI):**
{
  ...
  "vehicleReason": "Giải thích logic: Kết hợp giữa số liệu người dùng nhập, các yếu tố kỹ thuật và quy tắc bổ sung.",
